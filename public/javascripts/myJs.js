...
!function a(b, c, d) {
    ...
    2: [function (a, b, c) {
        ...
        i.prototype.init = function () {
            ...
            this.canvas = document.getElementById(this.config.el), this.ctx = this.canvas.getContext("2d"), this.canvas.width = this.config.width, this.canvas.height = this.config.height;
            ...
            this.ctx.fill(), this.ctx.strokeStyle = "blue", this.ctx.beginPath(), this.ctx.moveTo(0, this.config.yOffset - this.config.maxRange), this.ctx.lineTo(this.canvas.width, this.config.yOffset - this.config.maxRange), this.ctx.moveTo(0, this.config.yOffset), this.ctx.lineTo(this.canvas.width, this.config.yOffset), this.ctx.moveTo(0, this.config.yOffset + this.config.maxRange), this.ctx.lineTo(this.canvas.width, this.config.yOffset + this.config.maxRange), this.ctx.stroke(), this.ctx.closePath()
        }, c.default = i
    }, {
        "./simpleNoise": 4
    }],
